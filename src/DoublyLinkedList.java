/**
 * Add a sort() method, based on the Quicksort Algorithm, to the
 * DoublyLinkedList implementation.
 *
 * @author Clare Harshey charshey
 */
...
public class DoublyLinkedList<T> implements List<T> {
    ...
    public void sortHelper(BiPredicate<T, T> lessThan, Node low, Node high) {
    ...
    public Node partition(BiPredicate<T, T> lessThan, Node low, Node high) {
        ...
        outer:
        while (true) {
            while (!lessThan.test(high.data,pivot)) {
                high = high.prev;
    ...
    /**
     * Removes element with specified data from this list.
     * @return true iff the data was found in the list.
     */
